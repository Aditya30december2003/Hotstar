  ...
  return (
    <div className='grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 mt-20 gap-6 max-w-[80vw] mx-auto'>
      ...
      <div className='shadow-[4.0px_8.0px_8.0px_rgba(0,0,0,0.38)] cursor-pointer hover:scale-110 duration-500 overflow-hidden relative'>
        ...
        <video src={MarvelVideo} className='top-0 left-0 h-[100%] object-cover rounded-[0.4rem] absolute z-[-1] hover:z-[99]' preload='none' autoPlay muted loop></video>
      </div>
      ...
      <div className='shadow-[4.0px_8.0px_8.0px_rgba(0,0,0,0.38)] cursor-pointer hover:scale-110 duration-500 overflow-hidden relative'>
        ...
        <video src={DisneyVideo} className='top-0 left-0 h-[100%] object-cover rounded-[0.4rem] absolute z-[-1] hover:z-[99]' preload='none' autoPlay muted loop></video>
      </div>
      ...
      <div className='shadow-[4.0px_8.0px_8.0px_rgba(0,0,0,0.38)] cursor-pointer hover:scale-110 duration-500 overflow-hidden relative'>
        ...
        <video src={NationalVideo} className='top-0 left-0 h-[100%] object-cover rounded-[0.4rem] absolute z-[-1] hover:z-[99]' preload='none' autoPlay muted loop></video>
      </div>
      <div className='shadow-[4.0px_8.0px_8.0px_rgba(0,0,0,0.38)] cursor-pointer hover:scale-110 duration-500 overflow-hidden relative'>
        ...
        <video src={PixarVideo} className='top-0 left-0 h-[100%] object-cover rounded-[0.4rem] absolute z-[-1] hover:z-[99]' preload='none' autoPlay muted loop></video>
      </div>
      <div className='shadow-[4.0px_8.0px_8.0px_rgba(0,0,0,0.38)] cursor-pointer hover:scale-110 duration-500 overflow-hidden relative'>
        <img src={Star} alt="" className='border-2 border-white rounded-[0.4rem]  h-[100%] object-cover opacity-1  z-10 top-0'/>
        <video src={StarWars} className='top-0 left-0 h-[100%] object-cover rounded-[0.4rem] absolute z-[-1] hover:z-[99]' preload='none' autoPlay muted loop></video>
      </div>
    </div>
  )
}
